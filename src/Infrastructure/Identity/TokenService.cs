...
public sealed class TokenService(
    ...
    private ClaimsPrincipal GetPrincipalFromExpiredToken(string token) {
        ...
        var isJwtToken = securityToken is JwtSecurityToken jwtSecurityToken;
        var isHmacSha256 = securityToken is JwtSecurityToken jwtToken && jwtToken.Header.Alg.Equals(
            SecurityAlgorithms.HmacSha256,
            StringComparison.InvariantCultureIgnoreCase
        );

        if (!isJwtToken || !isHmacSha256) {
